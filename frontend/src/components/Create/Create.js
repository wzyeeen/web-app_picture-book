...
function Create(props) {
  // const [enterStoryContent, setEnterStoryContent] = useState('') // [state, setState
  // const handleEnterStoryContent = (event) => {
  //   setEnterStoryContent(event.target.value)
  // }
  // const handleStoryContentSubmit = (event) => {
  //   event.preventDefault()
  //   console.log(enterStoryContent)
  // }
  return (
          ...
          <div className="self-stretch flex flex-col items-stretch mt-12 mb-4 px-10 max-md:mt-10 max-md:px-5">
            <div className="flex w-full max-w-full items-stretch gap-1.5 mt-1.5 max-md:justify-center">
              <Textarea name="Soft" variant="soft" required size="lg" minRows={4}
                type="text"
                // value={enterStoryContent}
                // onChange={handleEnterStoryContent}
            ...
            <Button
              as={Link}
              // onClick={handleStoryContentSubmit}
              to="/ChooseStyle"
